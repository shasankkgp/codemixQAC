...
class Langdetect_Fasttext:
    def __init__(self):
        ...
        model_path = "/Users/shasankgedda/Desktop/RESEARCH/QAS-codemix/models/fasttext/lid.176.bin"
...
if __name__ == "__main__":
    ...
    DATA_PATH = "/Users/shasankgedda/Desktop/RESEARCH/QAS-codemix/datasets/msmarco"
    df = pd.read_csv(os.path.join(DATA_PATH,"queries_train.tsv"),sep="\t",header=None,usecols=[1,2])
    op_path = "/Users/shasankgedda/Desktop/RESEARCH/QAS-codemix/datasets/master/msmacro/fasttext"
    output_file = open(os.path.join(op_path,"msmarco_detect_train.jsonl"), 'w', encoding='utf-8')


    # DATA_PATH = "/Users/shasankgedda/Desktop/RESEARCH/QAS-codemix/datasets/amazon-kdd22-t2/data/processed/public/task_2_multiclass_product_classification"
    # df = pd.read_csv(os.path.join(DATA_PATH,"train-v0.3.csv"),usecols=[1,3])
    # op_path = "/Users/shasankgedda/Desktop/RESEARCH/QAS-codemix/datasets/master/amazonshop/fasttext"
